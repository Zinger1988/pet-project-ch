...
const MenuBtn: React.FC<MenuBtnProps> = ({ onClick, className = '', isActive = 'false' }) => {
  ...
  const btnStyles = 'relative w-16 h-16 bg-yellow-400 transtion-colors duration-300 hover:bg-yellow-300';
