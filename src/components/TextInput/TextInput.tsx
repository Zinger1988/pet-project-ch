...
const TextInput: React.FC<TextInputProps & InputHTMLAttributes<HTMLInputElement>> = ({
  ...
  const inputStyles = `block w-full border-2 border-black rounded-xl py-2.5 px-4 focus:border-primary-400 transition-colors outline-none placeholder:transition-opacity focus:placeholder:opacity-0`;
