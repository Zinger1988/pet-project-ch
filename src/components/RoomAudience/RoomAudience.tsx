...
import { AudienceAvatar, RoomAudienceList } from "../";
...
const RoomAudience: React.FC<RoomAudienceProps> = ({ members, userId }) => {
  ...
  return (
    <div>
      ...
      <div className="p-4 lg:p-5 border-2 border-gray-200 dark:border-gray-600 rounded-xl">
        {online.length > 0 && (
          <RoomAudienceList
