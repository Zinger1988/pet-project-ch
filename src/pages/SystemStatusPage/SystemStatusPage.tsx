    ...
    <section className="my-16">
      <Container className="max-w-screen-lg">
        <StatusBanner
          ...
          statusText={data.overall.statusText}
        />
        ...
        >
          <div className="bg-gray-100 p-8 rounded-lg">
            <Form className="mx-auto sm:flex sm:gap-4 sm:items-start">
              <Field
                ...
                id="email"
                className="sm:flex-grow mb-3 sm:mb-0"
              />
              <Button type="submit" className="w-full sm:w-auto rounded-2xl h-[48px]">
                {t("buttons.subscribe")}
              </Button>
            </Form>
          </div>
