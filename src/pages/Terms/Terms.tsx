    ...
    <Container className="max-w-screen-md mt-12 mb-24">
      <article>
        ...
        <p>
          ...
          that you have read and agree to our <a href="#">Community Guidelines</a>.
        </p>
        <p>
          These Terms contain an arbitration clause that applies to residents of the
          United States. Please review Section 11 of the Terms for details.
        </p>
        <h2>
          <strong>
        ...
        <p>
          Among other things, our Products allow you to use your voice to interact with
          others in real time through “Conversations.” These audio Conversations may
          include  “Chats,” “Live Rooms,” and Voice Messages called “VMs” or “Messages”.
          Our Products also allow you to  share recordings of your interactions for others
        ...
        <p>
          <strong>Guest Users: </strong>We may also allow you to use our Products to a
          limited extent without opening an account, such as by allowing you to
          participate in audio conversations with other users. You may be able to join a
          Conversation (such as a Chat or Live Room) or a community (a “House”), to speak
          to other users in real time for a limited amount of time using a link, or accept
          invitations for Conversations (such as Live Rooms) scheduled for a future date.
          Before you can participate in Conversations as a Guest User, we may ask you for
          some information (i.e. your name) which will be used to identify you to other
          users for the duration of your experience while using our Products. We will only
          allow you to do so if you agree to our Terms like any other user must; all
          provisions of our Terms, our Privacy Policy, and our Community Guidelines apply
          to you the same as they do for any other user.
        </p>
        <p>
          Subject to these Terms and our policies (including our
          <a href="#">Community Guidelines</a>), we grant you a limited, non-exclusive,
          non-transferable and revocable license to use our Products. If you are using the
          Products on behalf of a business or some other entity, you represent that you
          are authorized to bind that business or entity to these Terms and you agree to
          these Terms on behalf of that business or entity (and all references to “you”
          and “your” in these Terms will mean both you as the end user and that business
          or entity).
        </p>
        <p>
          Some of our Products may consist of software that is downloaded to your
          computer, phone, tablet, or other device. You agree that we may automatically
          upgrade those Products, and these Terms will apply to all upgrades.
        </p>
        <p>
          By providing your mobile telephone number or email address, you agree that we
        ...
        <p>
          We may collect personal data of minors under 18, who in any case are of age
          under applicable privacy law. All users under 18 are defaulted into a “private
          profile” setting, which limits what information is publicly available. (Privacy
          settings for others’ Conversations and House conversations will vary based on
          the creator’s preferences.) You can change these settings in your profile at any
          time. More information about private profiles can be found in our
        ...
        <p>
          Our Products are personalized for you by design. We'll use your activity and
          interests on our apps and website to recommend Conversations, content you might
          want to share, Conversations you might want to start or join, other users to
          connect with, Houses or groups you can join, and other content we think may be
          interesting to you. For additional details, please see our Knowledge Center.
        </p>
        <h3>
          <strong>
        ...
        <p>
          Our Products allow you to interact with others through Conversations. You can
          start live conversations that happen in real-time (“Live Rooms”), or
          asynchronous conversations, including “Chats” and “Messages” or “VMs,” which do
          not happen in real time.
        </p>
        <p>
          Our Products also allow you to post content, including audio content, visual
          images, GIFs, text, and symbols. Anything you say, post, or make available in
        ...
        <p>
          You can share User Content with your “friends-only,” “friends-of-friends,” or
          “House” (user community) networks, depending on your set preferences. Your
          “friends-only” network includes just your “friends” (people who you add as a
          friend, who also add you back). Your “friends-of-friends” network includes your
          friends, as well as the users your friends are also friends with (including
          other users who you may not follow, or who may not follow you). A “House” is a
          community you can join with other users, where you can have Conversations
          (including Chats or Live Rooms) with other House members. A House may be “Open,”
          meaning any user can join it and participate in sharing content, or “Closed,”
        ...
        <p>
          ...
          so it’s important that you keep your account secure, and it is your
          responsibility to maintain the security of any passwords or other codes you use
          to access your account. If you think that someone has gained unauthorized access
        ...
        <p>
          ...
          providing, promoting, and improving our Products in any media formats or
          channels. This license includes a right for us to make your content available
        ...
        <p>
          ...
          Products. While we’re not required to do so, we may access, review, screen, and
          delete your User Content at any time and for any reason, including to provide
          and develop our Products or if we think your User Content violates these Terms,
          our <a href="#">Community Guidelines</a>, or other policies.
        </p>
        <h3>
          <strong>
        ...
        <p>
          ...
          Terms of Service to work to provide a safe space for your Conversations and
          combat illegal and harmful conduct and content.
        </p>
        <p>
          If we receive a complaint regarding violations of our Community Guidelines or
          our Terms of Service, or otherwise illegal or illicit activity, we will
          investigate accordingly, which may include reviewing any available recordings.
        </p>
        <p>
        ...
        <p>
          <strong>Live Rooms.</strong> If we receive a complaint while a Room is live, we
          will review the recording to determine whether a violation has occurred.  We
          will retain the recording as long as reasonably necessary to investigate the
          potential violation. Otherwise, we delete the recording shortly after the Live
          Room ends.
        </p>
        <p>
          <strong>Chats. </strong>We record and save all Chats by default. We make Chats
          available to other users depending on the privacy setting preferences set by the
          user that started the Chat (the “Chat Creator”). Depending on a Chat Creator’s
          privacy settings and selected audience, when the Chat Creator creates a Chat, it
          may be shared with their “friends-only” network, their “friends-of-friends”
          network, or the audience of a specific House, as well as others who are invited
          into the room or enter it via a shared link. Full details of how to set up your
          privacy preferences for Chats can be found on our
          <a href="#">Knowledge Center</a>. Chats are created and saved at the direction
          of Chat Creators, and remain available unless a Chat is deleted by the Chat
          Creator, or unless participant(s) in the Chat delete a specific audio comment (a
          section of an audio Chat or VM) they have created.
        </p>
        <p>
          <strong>Voice Messages. </strong>We record and save all voice messages
          (“Messages” or “VMs”) by default. We make VMs available to one or more users who
          have been invited to participate in the conversation. VMs are created and saved
          at the direction of the creator of a VM, and remain available unless a VM is
          deleted by the creator of the VM, or unless participant(s) in the VM delete
          specific audio segments they created.
        </p>
        <p>
        ...
        <p>
          ...
          or its moderators may disable optional audio recording features, such as
          Replays.
        </p>
        <p>
          <strong>Guest Users.</strong> If you provide identifying information or create
          content as a Guest User, that information and content may be recorded, saved,
          and shared indefinitely with other users, depending on the privacy settings of
          the Conversation that are set by its creator.
        </p>
        <h3>
          <strong>
        ...
        <p>
          We always love to hear from our users, but you are not required to provide us
          with feedback. If you do provide feedback or suggestions to us, we may use your
          feedback and suggestions without compensating you, and without any restriction
          or obligation to you. You agree that we will own all rights in any materials or
          other items that we develop based on your feedback or suggestions.
        </p>
        <h2>
          <strong>
        ...
        <p>
          It’s our policy, in appropriate circumstances and at our discretion, to disable
        ...
        <p>
          If you’re a copyright owner or authorized to act on behalf of one, you can
          report alleged copyright infringements on our Products by completing the DMCA
          Notice of Alleged Infringement and sending it to our designated copyright agent.
        ...
        <p>
          If you'd prefer not to use this form, please send the following information to
          our designated copyright agent:
        </p>
        <p>
          1. Identify the copyrighted work you believe has been infringed. If you’re
          reporting multiple copyrighted works, you can provide a representative list of
          those copyrighted works.
        </p>
        <p>
          2. Identify the content on our Product you claim to be infringing your rights,
          including the information we need to help us find it, such as a URL.
        </p>
        ...
        <p>
          ...
          copyrighted material or reference or link to such material is not authorized by
          the copyright owner, its agent, or the law (for example, as a fair use)."
        </p>
        <p>
          "I hereby state that the information in this notice is accurate and, under
          penalty of perjury, that I’m the owner, or authorized to act on behalf of the
          owner of the copyright or of an exclusive right under the copyright that’s
          allegedly infringed."
        </p>
        <p>
          5. Include your full legal name and your electronic or physical signature (for
        ...
        <p>
          ...
          get in touch with us for any other reason, please visit our
          <a href="#">Knowledge Center</a>.
        </p>
        <p>
        ...
        <p>
          We record Conversations in Live Rooms so that we can investigate any complaints
          regarding violations of our Community Guidelines or our Terms of Service or
          otherwise illegal or illicit activity, as explained in Section 3.C above. We
          record Conversations in Chats and VMs, including Conversations that take place
          within Houses, as a part of the Products, and we may review available recordings
          associated with these Conversations if we receive an associated complaint. We
          may also use automated systems, whenever necessary with human intervention, to
          scan the names of rooms, images, or other surfaces to identify potential
          violations. We may generate transcripts of audio, either through our own means
          or third-party services, in order to review content for illegal activity or
        ...
        <p>
          Examples of third-party services and content that may be integrated with our
          Products include social integrations, which may be used to provide you with
          social sharing, and to allow you to share your content on other platforms; and
        ...
        <p>
          We’re improving our Products and creating new ones all the time. That means we
          may add or remove features, products, or functions of our Products, and we may
          also suspend or stop providing our Products. We may take any of these actions at
          any time for any reason, and when we do, we may not provide you with any notice
          beforehand.
        </p>
        <p>
        ...
        <ul>
          <li>
            if you are under the age of 18, you may be limited from accessing certain
            types of content or features;
          </li>
          <li>
            if another user has blocked you, you will not be able to see content from
            them;
          </li>
          <li>
            if your account is found to have violated our terms or policies, and your
            account is not immediately terminated, you may retain access to the service
            but be limited from using certain features, or sharing content;
          </li>
        ...
        <p>
          Our Products and all included content are provided on an "as is" basis without
        ...
        <p>
          ...
          TO OR USE OF OR INABILITY TO ACCESS OR USE THE PRODUCTS; (B) ANY CONDUCT OR
          CONTENT OF ANY THIRD PARTY ON THE PRODUCTS, INCLUDING, WITHOUT LIMITATION, ANY
          DEFAMATORY, OFFENSIVE OR ILLEGAL CONDUCT OF OTHER USERS OR THIRD PARTIES; OR (C)
        ...
        <p>
          ...
          a claim (including disputes about the scope, applicability, enforceability,
          revocability, or validity of the Arbitration Agreement) will be decided by the
        ...
        <p>
          ...
          motions to dismiss and demurrers, applying the standards set forth for such
          motions under the California Code of Civil Procedure. The arbitrator will issue
          a written decision on the merits, the arbitrator will have the power to award
          any remedies available under applicable law, and the arbitrator may award
          attorneys’ fees and costs to the prevailing party where permitted by applicable
          law. The decree or award rendered by the arbitrator may be entered as a final
          and binding judgment in any court having jurisdiction thereof.
        </p>
        <p>
          Subject to the Federal Arbitration Act’s exclusive applicability to the
          enforcement of this agreement to arbitrate, you agree that the arbitrator will
          ...
          California Civil Discovery Act. You agree that any arbitration under this
          agreement will be conducted in the county in which you live or such other
          mutually-agreed location. If the claim is for less than $10,000 (ten thousand
          U.S. dollars) (and doesn’t involve injunctive relief), you may choose whether
          the arbitration is conducted (i) solely on the basis of documents submitted to
          the arbitrator, (ii) through telephone or video calls, or (iii) by an in-person
          hearing under the JAMS rules in your county of residence.
        </p>
        <p>
        ...
        <p>
          ...
          to its conflict of laws principles. If the laws in your country require
          agreements with consumers to be governed by the local laws, then Section 12 does
          not apply to you.
        </p>
        <h2>
          <strong>
        ...
        <p>
          ...
          always be available on our website and via our apps. Unless otherwise required
          by law, or where we need to make urgent changes for safety, security or
          regulatory reasons, we will give you reasonable advance notice through
          appropriate, transparent notifications (for example, through our Products) of
          material changes to these Terms which impact you and the date that they will
          come into force. The changes will only apply to our relationship going forward.
          If you do not agree to the changes to the Terms, you will have to stop using our
          Products. If you continue to use the Products once the changes come into effect,
          we will take that as your acceptance of the updated Terms.
        </p>
        <h3>
          <strong>
